...
//  Serial.println("in end tft write");
//  sleep(2);
...
//  Serial.println("begin write");
  begin_tft_write();
//  Serial.println("begin write over");
  DC_C;
//  Serial.println("after dc_c");
  tft_Write_8(c);
//  Serial.println("after tft write8");
  DC_D;
