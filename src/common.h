...
//#include "font/taotao_45.h"
#include "font/name_42.h"
...
//#define KEY "7de934b2cca745c989f5cbedc4c0c195"  //test_tianqi key
#define KEY "20ba59bde7c149d88c3f6949f7770b98"  //pay money key
// 天气接口
const String cityURL = "https://geoapi.qweather.com/v2/city/lookup?key=";  //查询城市代码的接口
//以下地址为付费地址，每十次1分钱。
const String nowURL = "https://api.qweather.com/v7/weather/now?key="; // 实时天气接口
